...
export function ContactForm() {
  ...
  const whatsappUrl = `https://wa.me/918722579999?text=${encodeURIComponent(
  ...
  return (
    <div className="grid md:grid-cols-2 gap-12">
      ...
      <div className="space-y-6">
        ...
        <a href="mailto:info@vaultpeptides.in"
          className="flex items-center gap-4 p-5 bg-card border border-border rounded-lg hover:border-primary/40 transition-colors group">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Textarea rows={5} value={message} onChange={(e) => setMessage(e.target.value)}
              placeholder="How can we help?" className="rounded-none font-sans text-sm resize-none"
              style={{ backgroundColor: "#FAF5EE", borderColor: "#C8B89E", color: "#1A0E05" }} />
          </div>

          {/* Native <a> tag so it's never blocked by popup blockers */}
          <a
          ...
          <p className="font-sans text-xs text-center" style={{ color: "#6B5A42" }}>
            Fill in Name and Message to enable. Opens WhatsApp with your message pre-filled.
          </p>
        </div>
      )}
    </div>
